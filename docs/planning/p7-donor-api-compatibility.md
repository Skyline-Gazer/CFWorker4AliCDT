...
test actions stay fail-closed placeholders (SMTP/webhook report configuration
codes; Telegram remains unavailable until FEATURE-07). The donor logs view is a projection of the same bounded
